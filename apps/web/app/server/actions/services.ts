...
import {
    Sponsor, Event, EventMap, Lecture, TechspardhaTeam,
    TechspardhaTeamsDTO, Notification, NotificationsDTO,
    GetAllDetailedEvents, GetAllNotifications
} from "./constants";
...
const SERVICES = {
    ...
    getAllEvents: async (): Promise<Array<{ eventName: string, eventCategory: string }>> => {
