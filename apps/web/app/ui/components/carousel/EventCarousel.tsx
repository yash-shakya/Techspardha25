...
export default function StoriesCarousel() {
  ...
  return (
    ...
    <div className="w-[100vw] h-full md:h-[507px] flex justify-start relative overflow-y-visible mb-10">

<div className="hidden lg:block h-[86%] w-[250px] absolute top-0 left-0 bg-gradient-to-r from-[#001926] to-[#F3F9FF00] z-20"  />
<div className="hidden lg:block h-[86%] w-[250px] absolute top-0 right-0 bg-gradient-to-l from-[#001926] to-[#F3F9FF00] z-20" />
      <div
