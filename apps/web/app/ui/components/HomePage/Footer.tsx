...
import { FaDiscord, FaLinkedinIn, FaTwitter, FaYoutube, FaInstagram } from "react-icons/fa";
...
export default function Footer() {
  return (
    <footer className="relative bg-transparent py-8 px-4">
      {/* <div
        className="absolute w-screen mt-10  inset-0 -z-10"
        style={{
      ...
      <div className="container mx-auto flex flex-col items-center ">
        ...
        <p className="text-white text-xs md:text-sm flex items-center gap-1 pt-2 border-t-2 mb-5 border-[#00a6ff66]">
          Developed with{" "}
          <span className="text-red-500 animate-pulse">❤️</span> by Technobyte
        </p>
