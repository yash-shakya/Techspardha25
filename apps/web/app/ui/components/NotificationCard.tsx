      ...
      <div className="w-[270px] h-[168px] flex flex-col gap-[20px]">
        {tempNotifications.map((tempNoti, i) => {
          if (i === 0) {
            return (
              <div
                className="w-[270px] h-6 flex flex-row-reverse justify-between"
                key={i}
              >
                <div className="text-[#e5e1e6] text-2xl font-bold font-['Satoshi Variable'] uppercase leading-normal">
                  {tempNoti.title}
                </div>
                <div className="text-[#e5e1e6] text-2xl font-extrabold font-['JetBrains Mono'] uppercase leading-normal">
                  &gt;&gt;
                </div>
              </div>
            );
            ...
            return (
              <div
                ...
                key={i}
              >
                <div className="text-[#e5e1e6]/60 text-2xl font-bold font-['Satoshi Variable'] uppercase leading-normal">
                  {tempNoti.title}
                </div>
                <div className="text-[#e5e1e6]/60 text-2xl font-extrabold font-['JetBrains Mono'] uppercase leading-normal">
                  &gt;&gt;
                </div>
              </div>
            );
