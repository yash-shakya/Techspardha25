...
export default function CarouselComponent({
	...
	return (
		<>
			...
			<Carousel
				opts={{
					align: "center", // Ensure items align correctly without overlap
        ...
        <div className="hidden lg:block h-[100%] w-[200px] absolute top-0 left-0 bg-gradient-to-r from-[#001926] to-[#F3F9FF00] z-20"  />
        <div className="hidden lg:block h-[100%] w-[200px] absolute top-0 right-0 bg-gradient-to-l from-[#001926] to-[#F3F9FF00] z-20" />
